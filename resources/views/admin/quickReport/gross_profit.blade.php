    ...
    <section class="content">
        ...
        <!-- details start -->
            <div class="d-flex justify-content-center">
                <form class="form-inline mb-5" method="post" action="{{route('order.grossProfit.report')}}" >
                    @csrf() 
             ...
             <h4 class="text-center">Gross profit in details Month {{date('d-m-Y',strtotime($start))}}  TO  {{date('d-m-Y',strtotime($end))}}</h4>
            <div class="card">
                <div class="card-body">
