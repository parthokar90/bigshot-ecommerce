            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  @endphp 
                  @if(isset($cost)) 
                    {{number_format($cost->meta_value*$item->total_qty)}} tk @php $total_cost+=$cost->meta_value*$item->total_qty; @endphp
                  @endif
                </td>
                  <td class="right">
                    @php 
                    ...
                    @endphp 
                    @if(isset($price)) 
                    {{number_format($price->meta_value*$item->total_qty)}} tk @php $total_sale+=$price->meta_value*$item->total_qty; @endphp
                    @endif
                  </td>
                </tr>   
               @endforeach
